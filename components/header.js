...
<header class="nav">
  <div class="wrap">
    ...
    <nav class="nav-links" id="navLinks">
      <a href="index.html" data-nav-link="index">Home</a>
      <a href="our-work.html" data-nav-link="our-work">Our Work</a>
      <a href="services.html" data-nav-link="services">Services</a>
      <a href="contact.html" data-nav-link="contact">Contact</a>
    </nav>
    <div class="nav-cta">
      <a href="contact.html" class="btn btn-outline btn-sm">Start a project</a>
